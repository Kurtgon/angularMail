...
/**
 * Un HttpInterceptor funciona, como su nombre indica, interceptando todas las peticiones web que salen desde
 ...
 * 1º.- Todas las peticiones que salgan de la aplicación se van a dirigir hacia un servidor concreto. En este caso el servidor
 *      será 'http://localhost:8080' o cualquier otro.
 * 2º.- Todas las peticiones web, antes de salir hacia su destino, realizarán los siguientes pasos:
 *      1.- Comprueban si el servicio 'AutenticadorJwtService' tiene un token JWT guardado.
 *      2.- En caso de que el token JWT exista, se incorpora a una cabecera (Authorization) del request, tras el texto 'Beare '.
 * 3º.- Estableceremos un único tipo de comunicaciones, será 'application/json', y una codificación 'charset=utf-8'
 * 
 * Es siempre recomendable implementar un HttpInterceptor, las aplicaciones de esto ya se nos ocurrián, son muchas.
 * 
