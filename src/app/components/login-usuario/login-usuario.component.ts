...
export class LoginUsuarioComponent implements OnInit {
  ...
  /**
   * Le pido al inyector de código que genere objetos de determinados topos, útiles
   */
   ...
   */
  ngOnInit(): void {
    // Inicializo el objeto FormGroup, es la base para usar formularios reactivos, en los que la validación y el control
  ...
  /**
   * Método que autentica un usuario con los valores expuetos en el formulario del template
   */
  autenticaUsuario(){
    //Inicio un diálogo de carga
    this.comunicacionAlertas.abrirDialogCargando();
    // Utilizo el "UsuarioService" para enviar los datos de logado y subscribirme a la respuesta del servidor
